...
Start-Sleep -Milliseconds 500    # Wait longer to ensure the action completes

[Keyboard]::PressKey(0x09)       # Press Tab
Start-Sleep -Milliseconds 500    # Wait to ensure the action is registered
...
[Keyboard]::PressKey(0x09)       # Press Tab
Start-Sleep -Milliseconds 200    # Wait to ensure the action is registered
